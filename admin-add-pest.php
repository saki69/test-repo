        	...
        	<section class="view" style="border:none;background:#eee;">
            		<style>
            	  	...
            	  	<div class="add-crop">
                    	<h2>Add Pest (Rice)</h2>
                    	<form>
                        	<label>Pest Name</label><br /><br />
                            <input type="text" /><br /><br />
                            <label>Local Name</label><br /><br />
                            <input type="text" /><br /><br />
                            <label>Symptoms</label><br /><br />
                            <textarea></textarea><br /><br />
                            <label>Image</label><br /><br />
                            <label>Pesticide</label><br /><br />
                            <input type="text" /><br /><br />
                             <label>Pesticide Description</label><br /><br />
                            <textarea></textarea><br /><br />
                            <label>Usage Limit</label><br /><br />
                            <input type="text" /><br /><br />
